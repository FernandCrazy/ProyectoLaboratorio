...
public class FUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TDatos.setBackground(new java.awt.Color(255, 255, 255));
        TDatos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Quimico encargado", "Nombre de usuario", "Cedula Profesional"
            }
        ));
        jScrollPane1.setViewportView(TDatos);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(49, 19, 678, 146));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 110, 310));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 670, -1));
        ...
        jXSearchPanel1.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(61, 61, 61)
                        .addComponent(CBPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(89, 89, 89)
                        .addComponent(CBGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(22, 22, 22)
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 670, 210));
    ...
    private void CBPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CBPerfilActionPerformed
        ...
        ConexionBDV cnx = new ConexionBDV();
        String selectedItem = (String) CBPerfil.getSelectedItem();

        if (selectedItem != null) {
            cnx.cargarExamenesPerfil(TDatos, selectedItem);
        }
    ...
    private void CBGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CBGrupoActionPerformed
        ...
        String selectedItem = (String) CBGrupo.getSelectedItem();

        if (selectedItem != null) {
            cnx.cargarExamenesGrupo(TDatos, selectedItem);
        }
