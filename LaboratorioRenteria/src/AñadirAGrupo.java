 ...
 */
public class AñadirAGrupo extends javax.swing.JDialog {

    /**
     * Creates new form Grupos
     */
    public AñadirAGrupo(java.awt.Frame parent, boolean modal, String Clave, String Nombre) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        BGuardar.setText("Agregar Examenes");
        ...
        setTitle("Añadir Examen a Grupo");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 350, 200));
        ...
        getContentPane().add(BNuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, 132, 36));
    ...
    private void BNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BNuevoMouseClicked
        ConexionBDV cnx = new ConexionBDV();
        String Grupo = TFClave.getText();

        for (int fila = 0; fila < TDatos.getRowCount(); fila++) {
            String idExamen = TDatos.getValueAt(fila, 0).toString();
            String consultaExa = "INSERT INTO examengrupo "
                    + "VALUES (null, '" + idExamen + "', '" + Grupo + "')";
    ...
    private void BGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BGuardarActionPerformed
        ...
        String consulta = "INSERT INTO grupo "
                + "VALUES (null,'" + Nombre + "')";
    ...
    private void BGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BGuardar1ActionPerformed
        ExamenesParaGrupo fme = new ExamenesParaGrupo(this, true);
        fme.setVisible(true);
...
//            public void run() {
//                AñadirAGrupo dialog = new AñadirAGrupo(new javax.swing.JFrame(), true);
