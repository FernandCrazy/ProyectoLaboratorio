 ...
 */
public class ExamenesParaPerfil extends javax.swing.JDialog {

    AñadirAPerfil padre;

    public ExamenesParaPerfil(JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        padre = (AñadirAPerfil) parent;
    }
    ...
    private void BAgregarIndividual1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BAgregarIndividual1MouseClicked
        int fila_seleccionada = TIndividual.getSelectedRow();
        padre.setdatos(TIndividual.getValueAt(fila_seleccionada, 0).toString(), TIndividual.getValueAt(fila_seleccionada, 1).toString());
        this.dispose();
