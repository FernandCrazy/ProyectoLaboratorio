 ...
 */
public class MostrarGrupos extends javax.swing.JDialog {

  JTextField TFClave1,  TFNombre1;
  
    public MostrarGrupos(JDialog parent, boolean modal) {
        super(parent, modal);
          MostrarGrupos();
      ...
      public MostrarGrupos(JDialog parent, boolean modal, JTextField clave, JTextField nombre) {
        super(parent, modal);
         this.TFClave1=clave;
    ...
    private void initComponents() {
        ...
        jScrollPane7.setViewportView(TGrupos);
    ...
    private void BQuitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BQuitarActionPerformed
        ...
        int fila = TGrupos.getSelectedRow();
        DefaultTableModel modelo = (DefaultTableModel) TGrupos.getModel();
    ...
    private void TFBuscadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TFBuscadorActionPerformed
        ConexionBDV cnx = new ConexionBDV();
        cnx.mostrarDatosParaGruposBuscador(TGrupos, TFBuscador);
        cnx.cerrarConexiones();
...
//        TFNombre.setText(TIndividual.getValueAt(fila_seleccionada, 1).toString());
        String clave = TGrupos.getValueAt(fila_seleccionada, 0).toString();
        String nombre = TGrupos.getValueAt(fila_seleccionada, 1).toString();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarGrupos dialog = new MostrarGrupos(new JDialog(), true);
