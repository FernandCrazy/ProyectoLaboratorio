 ...
 */
public class MostrarPerfiles extends javax.swing.JDialog {

  JTextField TFClave1,  TFNombre1;
  
    public MostrarPerfiles(JDialog parent, boolean modal) {
        super(parent, modal);
      ...
      public MostrarPerfiles(JDialog parent, boolean modal, JTextField clave, JTextField nombre) {
        super(parent, modal);
         this.TFClave1=clave;
   ...
   public void MostrarPerfiles() {
    ...
    private void initComponents() {
        ...
        TPerfiles.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TPerfilesMouseClicked(evt);
            }
        });
        jScrollPane7.setViewportView(TPerfiles);
    ...
    private void BQuitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BQuitarActionPerformed
        ...
        int fila = TPerfiles.getSelectedRow();
        DefaultTableModel modelo = (DefaultTableModel) TPerfiles.getModel();
    ...
    private void TFBuscadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TFBuscadorActionPerformed
        ConexionBDV cnx = new ConexionBDV();
        cnx.mostrarDatosParaPerfilesBuscador(TPerfiles, TFBuscador);
        cnx.cerrarConexiones();
    ...
    private void TPerfilesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TPerfilesMouseClicked
        int fila_seleccionada = TPerfiles.getSelectedRow();
...
//        TFNombre.setText(TIndividual.getValueAt(fila_seleccionada, 1).toString());
        String clave = TPerfiles.getValueAt(fila_seleccionada, 0).toString();
        String nombre = TPerfiles.getValueAt(fila_seleccionada, 1).toString();
        TFClave1.setText(clave);
        TFNombre1.setText(nombre);
        this.dispose();
    }//GEN-LAST:event_TPerfilesMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarPerfiles dialog = new MostrarPerfiles(new JDialog(), true);
